...
def func_open():
    global window,canvas,paper,photo,photo2,oriX,oriY
    readFp=askopenfilename(parent=window,filetypes=(("모든그림파일","*jpg;*.jpeg;*.bmp;*.png;*.tif;*.gif"),("모든파일","*.*")))
...
def func_bright():
    global window,canvas,paper,photo,pgoto2,oriX,oriY
